...
class NewsApiResonse {
  ...
  factory NewsApiResonse.fromJson(Map<String, dynamic> json) {
    List<Article> articleList = List<Article>.from(json["articles"].map((x) => Article.fromJson(x)));
    return NewsApiResonse(
